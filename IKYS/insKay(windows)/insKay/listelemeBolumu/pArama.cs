...
namespace insKay
{
    public partial class pArama : Form
    {
        ...
        private void btn_ara_Click(object sender, EventArgs e)
        {
            ...
            string sorgu = "SELECT tKimlik.ad,tKimlik.soyad,tKimlik.medeniHali,tEgitim.sehir,tEgitim.tel,tEgitim.egitimDurumu FROM tKimlik INNER JOIN tEgitim ON tKimlik.tcNo=tEgitim.tcNo WHERE tEgitim.egitimDurumu='"+ egitimDurumu +"' AND tEgitim.calistigiBolum='"+ bolum+"' AND tKimlik.cinsiyet='"+cinsiyet+"'";
